...
public class ProductServlet extends HttpServlet {
        ...
        try {
            if (idParam != null) {
                ...
                if (product.isPresent()) {
                    response.getWriter().write(gson.toJson(product.get()));
                } else {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.getWriter().write(gson.toJson(
                    new SuccessResponse("Prodotto creato con successo", savedProduct)));
    ...
    protected void doPut(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.getWriter().write(gson.toJson(
                    new SuccessResponse("Prodotto aggiornato con successo", updatedProduct.get())));
        } catch (NumberFormatException e) {
            writeError(response, HttpServletResponse.SC_BAD_REQUEST, "ID non valido");
        } catch (IllegalArgumentException e) {
            writeError(response, HttpServletResponse.SC_BAD_REQUEST, e.getMessage());
